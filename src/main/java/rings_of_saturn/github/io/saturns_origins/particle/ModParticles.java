...
public class ModParticles {
    public static final OneTickParticle ONE_TICK_PARTICLE = registerParticle("one_tick_particle", FabricParticleTypes.simple());

    private static OneTickParticle registerParticle(String name, OneTickParticle particleType){
