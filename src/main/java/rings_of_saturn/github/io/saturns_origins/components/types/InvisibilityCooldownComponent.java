...
public class InvisibilityCooldownComponent implements IntComponent, AutoSyncedComponent {
    private int value = 0;
    private final Object provider;
    public InvisibilityCooldownComponent(Object provider) {
    ...
    public void setValue(int value) {
        this.value = value;
        ModComponents.INVIS_COOLDOWN.sync(this.provider);
    }
