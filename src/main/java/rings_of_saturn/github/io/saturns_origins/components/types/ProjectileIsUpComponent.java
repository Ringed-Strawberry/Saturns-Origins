...
public class ProjectileIsUpComponent implements BooleanComponent, AutoSyncedComponent {
    private boolean value = false;

    private final Object provider;
    public ProjectileIsUpComponent(Object provider) {
    ...
    public void setValue(boolean value) {
        this.value = value;
        ModComponents.PROJECTILE_IS_UP.sync(this.provider);
    }
