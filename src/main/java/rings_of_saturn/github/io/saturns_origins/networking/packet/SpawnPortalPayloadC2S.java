...
public record SpawnPortalPayloadC2S(Short stupid) implements CustomPayload {
    ...
    public static final PacketCodec<PacketByteBuf, SpawnPortalPayloadC2S> CODEC = PacketCodec.tuple(
            PacketCodecs.SHORT, SpawnPortalPayloadC2S::stupid, SpawnPortalPayloadC2S::new);
