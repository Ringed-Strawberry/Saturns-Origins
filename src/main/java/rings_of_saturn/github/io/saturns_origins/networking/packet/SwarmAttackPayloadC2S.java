...
public record SwarmAttackPayloadC2S(Short stupid) implements CustomPayload {
    ...
    public static final PacketCodec<PacketByteBuf, SwarmAttackPayloadC2S> CODEC = PacketCodec.tuple(
            PacketCodecs.SHORT, SwarmAttackPayloadC2S::stupid, SwarmAttackPayloadC2S::new);
